...
public class TesbihatTest {

    @Rule
    public ActivityTestRule<Tesbihat> mActivityTestRule = new ActivityTestRule<>(Tesbihat.class);
    ...
    public void takeScreenshots() throws Throwable {
        ...
        for (final String lang : langs) {
            ...
            TestUtils.takeScreenshot("tesbihat" + lang.toUpperCase(), act);
            act.finish();
