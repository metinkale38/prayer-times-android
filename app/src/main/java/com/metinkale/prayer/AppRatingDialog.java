...
public class AppRatingDialog {
    ...
    public static boolean showDialog(final AppCompatActivity act, long duration) {
    ...
    private static void showDialog(final AppCompatActivity act) {
