...
class MainFragment : BaseActivity.MainFragment(), LocationListener {
    ...
    override fun onCreateView(
        ...
        val v = inflater.inflate(R.layout.compas_fragment_main, container, false)
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        if (refresh === item) {
            ...
            if (mode == Mode.Map) {
                updateFrag(Mode.Compass)
                switch.setIcon(R.drawable.ic_compass_action_compass)
            } else if (mode == Mode.Compass) {
                updateFrag(Mode.Map)
                switch.setIcon(R.drawable.ic_compass_action_map)
            } else {
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        ...
        switch.setIcon(R.drawable.ic_compass_action_clock)
    }
