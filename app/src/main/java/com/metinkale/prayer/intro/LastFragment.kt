...
class LastFragment : IntroFragment(), CompoundButton.OnCheckedChangeListener, View.OnClickListener {
    override fun onCreateView(
        ...
        email.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_about_mail, 0, 0, 0)
        vote.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_about_star, 0, 0, 0)
        showIntro.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_about_intro, 0, 0, 0)
        share.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_about_share, 0, 0, 0)
        translate.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_about_translate, 0, 0, 0)
        return v
    }
