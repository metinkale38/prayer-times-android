...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private final OnPageChangeListener pageListener = new PageListener();
    // @formatter:on
    ...
    private int tabBackgroundResId = R.drawable.tesbihat_background_tab;
    ...
    public PagerSlidingTabStrip(@NonNull Context context, AttributeSet attrs, int defStyle) {
        ...
        tabsContainer.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
    ...
    private void addTab(final int position, @NonNull View tab) {
        ...
        tab.setOnClickListener(view -> pager.setCurrentItem(position));
    ...
    public int getTabpaddingStartRight() {
        return tabPadding;
    }

    public void setTabpaddingStartRight(int paddingPx) {
