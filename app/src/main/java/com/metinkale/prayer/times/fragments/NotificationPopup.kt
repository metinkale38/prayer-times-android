    ...
    class MyView @JvmOverloads constructor(
        ...
        override fun onSizeChanged(w: Int, h: Int, oldw: Int, oldh: Int) {
            ...
            silent = drawableToBitmap(
                ContextCompat.getDrawable(context, R.drawable.ic_times_volume_off),
                w / 5
            )
            close = drawableToBitmap(ContextCompat.getDrawable(context, R.drawable.ic_times_close), w / 5)
        }
