...
public class CompassFragment extends MainActivity.MainFragment implements LocationListener, RotationUpdateDelegate {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (mRefresh == item) {
            ...
            if (mMode == Mode.Map) {
                ...
                mSwitch.setIcon(MaterialDrawableBuilder.with(getActivity())
