...
public class Geocoder {
    ...
    public static List<Response> from(String address, int limit, String lang) {
        ...
        try {
            ...
            URL url = new URL("http://open.mapquestapi.com/nominatim/v1/search.php?key=eEA1yhyfXWENcMIC5V2VDA0nERdaIMzq&q=" + address.replace(" ", "+") + "&format=json&limit=" + limit + "&addressdetails=1&accept-language=" + lang);
