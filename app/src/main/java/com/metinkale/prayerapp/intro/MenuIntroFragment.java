        ...
        return new ArrayAdapter<String>(c, R.layout.drawer_list_item, c.getResources().getStringArray(R.array.dropdown)) {
            ...
            public View getView(int pos, View v, @NonNull ViewGroup p) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1
                    ...
                    ((TextView) v).setCompoundDrawablesWithIntrinsicBounds(0, 0, MainActivity.ICONS[pos], 0);
                } else {
                    ((TextView) v).setCompoundDrawablesWithIntrinsicBounds(MainActivity.ICONS[pos], 0, 0, 0);
                }
