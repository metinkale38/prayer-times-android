...
public abstract class Times extends TimesBase {
    ...
    public String getLeft(int next, boolean showsecs) {
        ...
        if (showsecs)
            ...
            return Utils.az(left.get(Calendar.HOUR_OF_DAY)) + ":" + (Utils.az(left.get(Calendar.MINUTE) + 1));
    ...
    public static class Alarm {
        ...
        public static Alarm fromBundle(Bundle bdl) {
            ...
            if (bdl.getString("vakit") != null)
                a.vakit = Vakit.valueOf(bdl.getString("vakit"));
        ...
        public Bundle toBundle() {
            ...
            if (vakit != null)
                bdl.putString("vakit", vakit.name());
