    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        map!!.addMarker(
            MarkerOptions().position(qaabaPos).anchor(0.5f, 0.5f)
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_compass_kaabe))
        )
    ...
    override fun onLocationChanged(location: Location) {
        ...
        if (line != null) {
            ...
            marker = map!!.addMarker(
                MarkerOptions().icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_compass_mylocation))
